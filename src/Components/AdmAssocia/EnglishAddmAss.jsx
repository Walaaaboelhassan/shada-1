        ...
        <div className="all-members">
          ...
          <div className="member !flex-row-reverse">
            ...
            <p>
              ...
              <span className="after:left-[-20px] text-start after:right-auto ml-[25px]">
                {" "}
                Higher leadership courses in executive management and financial
                strategy From insidead business school.{" "}
              </span>
              <span className="after:left-[-20px] text-start after:right-auto ml-[25px]">
                18 years of experience in the private sector in Saudi Arabia and
                the United Arab Emirates The United States and the Kingdom of
                Bahrain.
              </span>
              <span className="after:left-[-20px] text-start after:right-auto ml-[25px]">
              ...
              <span className="after:left-[-20px] text-start after:right-auto ml-[25px]">
                {" "}
                Chairman of the Board of Directors at AY Investment - Member of
                the Business Office Saudi Ethiopian Executive.{" "}
              </span>
            </p>
          </div>{" "}
          <div className="member !flex-row-reverse">
          ...
          <div className="member !flex-row-reverse">
            ...
            <p>
              ...
              <span className="after:left-[-20px] text-start after:right-auto ml-[25px]">
                Membership in the Sports Investment Council in Al-Baha Chamber.
              </span>
              <span className="after:left-[-20px] text-start after:right-auto ml-[25px]">
